...
<body onload="initialize();">
    <div id="app">
        ...
        <div id="assessments_div">
            <div id="instr_div">
                ...
                <div id="instr_div_table"></div>
            </div>
            <div id="public_div">
                <h1>Public Assessments</h1>
                <div id="public_div_table"></div>
            </div>
        </div>

        <div id="student_assessments_div">
            <a href="./student_assessments_view.php">Student Assessments View</a>
        </div>
        ...
        <main id="main" style="display:none">
            ...
            <div id="group1">
                <div id="group1_1">
                    <div class="group1_1_1">
                        ...
                        <img src="../assets/img/help_icon.png" alt="help icon" width="20" height="20" style="vertical-align:middle" title="Input a name for your assessment.">
                    </div>
                    <br><br>
                    <div class="group1_1_1">
                        ...
                        <img src="../assets/img/help_icon.png" alt="help icon" width="20" height="20" style="vertical-align:middle" title="Would you like your assessment to be accessible to other instructors/students?">
                    </div>
                    <br><br>
                    <div class="group1_1_1">
                        ...
                        <img src="../assets/img/help_icon.png" alt="help icon" width="20" height="20" style="vertical-align:middle" title="Input a number (representing minutes), for a student to take the assessment.">
                    </div>
                    <!-- hidden input -->
                ...
                <div id="group1_2">
                    <div class="group1_2_1">
                        ...
                        <img src="../assets/img/help_icon.png" alt="help icon" width="20" height="20" style="vertical-align:middle" title="Input a date in which assessment will be open for students to take.">
                    </div>
                    <br><br>
                    <div class="group1_2_1">
                        <label for="open_time"><strong>Open Time:</strong></label>
                        <input type="time" id="open_time" name="open_time" readonly required>
                        <img src="../assets/img/help_icon.png" alt="help icon" width="20" height="20" style="vertical-align:middle" title="Input a time in which assessment will be open for students to take.">
                    </div>
                    <br><br>
                    <div class="group1_2_1">
                        <label for="close_date"><strong>Close Date:</strong></label>
                        <input type="date" id="close_date" name="close_date" readonly required>
                        <img src="../assets/img/help_icon.png" alt="help icon" width="20" height="20" style="vertical-align:middle" title="Input a date in which assessment will be closed for students.">
                    </div>
                    <br><br>
                    <div class="group1_2_1">
                        <label for="close_time"><strong>Close Time:</strong></label>
                        <input type="time" id="close_time" name="close_time" readonly required>
                        <img src="../assets/img/help_icon.png" alt="help icon" width="20" height="20" style="vertical-align:middle" title="Input a time in which assessment will be closed for students.">
                    </div>
                </div>
            </div>
            ...
            <div id="group4">
                ...
                <br>
                <button class="action_btn" onclick="copyAssessment()">Copy Assessment</button>
                <button class="action_btn" onclick="downloadResults()">Download Results</button>
                <br>
        ...
        <div id="content-div" style="display:none">
            <div id="controls-div">
                ...
                <div id="ul-div">
                    <ul>
                        <li><b>Please note that the questions are displayed in order, from what is displayed on the
                                table from top to bottom.</b></li>
                        ...
                        <li><b>This means you will first see 2 questions of learning outcome 1.2.3, followed by 3
                                questions of learning outcome 1.2.4</b></li>
                    </ul>
                </div>
                <div id="buttons-div">
    ...
    <script type="text/javascript">
        ...
        let displayAssessments = () => {
            ...
            str += '</tbody>';
            str += '</table>';
            document.getElementById("instr_div_table").innerHTML = str;
            ...
            str += '</tbody>';
            str += '</table>';
            document.getElementById("public_div_table").innerHTML = str;
        }
        ...
        let openAssessmentResponse = () => {
            if (req1.readyState == 4 && req1.status == 200) {
                ...
                if (document.getElementById("student_assessments_div").style.display !== "none") {
                    document.getElementById("student_assessments_div").setAttribute('style', 'display:none');
                }
                ...
                document.getElementById("close_time").readOnly = true;
        ...
        let editAssessment = () => {
            ...
            if (assessment[1] === "<?= $_SESSION["email"]; ?>") {
                ...
                document.getElementById("close_time").readOnly = false;
        ...
        const copyAssessment = () => {
            try {
                ...
                req.open("POST", "pgsql/copy_assessment.php", true);
                req.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                req.onreadystatechange = function() {
                    if (req.readyState == 4 && req.status == 200) {
                        console.log(req.responseText);
                        if (req.responseText.trim() === "Successfully copied assessment.") {
                            alert("Successfully copied assessment.");
                            window.location.reload();
                        } else {
                            alert("There was an issue with copying the assessment.");
                            window.location.reload();
                        }
                    }
                };
                req.send(
                    ...
                    "course_name=" + "<?= $_SESSION["selected_course_name"]; ?>" + "&" +
        ...
        const downloadResults = () => {
            ...
            if (assessment[1] === "<?= $_SESSION["email"]; ?>") {
                try {
                    let req = new XMLHttpRequest();
                    req.open("POST", "pgsql/handleDownloadResults.php", true);
                    req.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    req.onreadystatechange = function() {
                        if (req.readyState == 4 && req.status == 200) {
                            if (req.responseText === "[]") {
                    ...
                    req.send(`assessment_name=${assessment[2]}`);
                } catch (err) {
                    console.log(err.message);
                }
            } else {
