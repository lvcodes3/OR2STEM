...
<body>
        ...
        <main>
            <div id="assessment-info">
                ...
                <div id="ul-list-div">
                    <ul>
                        <li>
                            <h3>You have a total duration of
                                <?= $assessment[4]; ?> minutes to complete this assessment.
                            </h3>
                        </li>
                        <li>
                            <h3>This assessment closes on:
                                <?= $assessment[7]; ?>
                                <?= $assessment[8]; ?>
                            </h3>
                        </li>
                        <li>
                            <h3 id="q-info-count"></h3>
                        </li>
                        <li>
                            <h3>The table below contains the learning outcomes that you will be assessed on. As well as
                                the break-down on number of questions and points per question for each learning outcome.
                            </h3>
                        </li>
                    </ul>
                </div>
            ...
            <div id="content-div">
                <div id="info-div">
                    ...
                    <h4>
                        ...
                        if there are any issues with the currently displayed question.
                    </h4>
                </div>
                <div id="iframe-div">
                    <div id="iframe-header-div">
    ...
    <script type="text/javascript">
        ...
        const sendEmail = () => {
            // retrieve and format the data to be sent
            const recipient = assessment[1];
            const subject = "Issue with Assessment Question: <?= $_SESSION["course_name"]; ?>";
            let body = "Hello, \n\n My name is <?= $_SESSION["name"]; ?> and I am in your <?= $_SESSION["course_name"]; ?> - <?= $_SESSION["course_id"]; ?> course. ";
            body += `There is an issue with the following assessment question: https://imathas.libretexts.org/imathas/embedq2.php?id=${sequence_question[counter]} \n\n`;
            body += "Thank you, <?= $_SESSION["name"]; ?>";

            // generate the mailto href
            // use encodeURIComponent to to encode special characters in the subject and body, ensuring that they are properly formatted in the mailto link
            const mailtoLink = `mailto:${recipient}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;

            // set the href attribute of the link element
            document.getElementById("issue-link").href = mailtoLink;
        }
